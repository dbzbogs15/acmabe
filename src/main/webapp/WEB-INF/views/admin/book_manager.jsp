            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <a style="margin-bottom: 10px" href="/admin/book/add" class="btn btn-primary">Thêm</a>
                                ...
                                <c:forEach items="${books}" var="book">
                                    <tr>
                                        <td style="text-align: center">
                                            <img style="width: 50px" src="/${book.image}"/>
                                        </td>
                                        <td>${book.name}</td>
                                        ...
                                        <td style="width: 13%">
                                            <div class="btn-group" role="group" aria-label="...">
                                                ...
                                                <a href="#" onclick="deleteBook(${book.id})" class="btn btn-default">
...
<script>
    ...
    function deleteBook(id) {
        swal({
            title:'Bạn muốn xóa quyển sách này',
            content: {
                element: 'a',
                attributes: {
                    href: '/admin/book/delete/' + id + '',
                    text: 'Xóa'
                }
            },
            button: {
